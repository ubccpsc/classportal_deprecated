    ...
    return (
      <div>
        ...
        <div className="module">
          ...
          <h5 className="text-left">This website uses GitHub's OAuth2 Web Application Flow to authenticate users and access your public GitHub profile. It never gains access to your login credentials, nor does it make any modifications your GitHub account.
